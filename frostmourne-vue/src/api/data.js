...
const dataApi = {
  ...
  findDataSource(pageIndex, pageSize, datasourceType) {
    return query.get(baseUrl + '/findDataSource', { pageIndex: pageIndex, pageSize: pageSize, datasourceType: datasourceType })
  },

  findDataSourceByType(datasourceType) {
    return query.get(baseUrl + '/findDataSourceByType', { datasourceType:  datasourceType})
  },
