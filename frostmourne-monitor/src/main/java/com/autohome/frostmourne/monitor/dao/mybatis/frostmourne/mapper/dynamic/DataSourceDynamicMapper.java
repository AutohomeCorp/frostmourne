...
public interface DataSourceDynamicMapper {
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2020-07-11T14:44:51.796+08:00", comments="Source Table: data_source")
    BasicColumn[] selectList = BasicColumn.columnList(id, datasource_name, datasource_type, service_address, creator, create_at, modifier, modify_at, properties);

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2020-07-11T14:44:51.795+08:00", comments="Source Table: data_source")
    ...
    int insertMultiple(MultiRowInsertStatementProvider<DataSource> multipleInsertStatement);
    ...
    default int insert(DataSource record) {
        return MyBatis3Utils.insert(this::insert, record, dataSource, c ->
            ...
            .map(datasource_name).toProperty("datasource_name")
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2020-07-11T14:44:51.795+08:00", comments="Source Table: data_source")
    default int insertMultiple(Collection<DataSource> records) {
        return MyBatis3Utils.insertMultiple(this::insertMultiple, records, dataSource, c ->
            c.map(id).toProperty("id")
            .map(datasource_name).toProperty("datasource_name")
            .map(datasource_type).toProperty("datasource_type")
            .map(service_address).toProperty("service_address")
    ...
    default int insertSelective(DataSource record) {
        return MyBatis3Utils.insert(this::insert, record, dataSource, c ->
            ...
            .map(datasource_name).toPropertyWhenPresent("datasource_name", record::getDatasource_name)
    ...
    static UpdateDSL<UpdateModel> updateAllColumns(DataSource record, UpdateDSL<UpdateModel> dsl) {
        return dsl.set(id).equalTo(record::getId)
                .set(datasource_name).equalTo(record::getDatasource_name)
    ...
    static UpdateDSL<UpdateModel> updateSelectiveColumns(DataSource record, UpdateDSL<UpdateModel> dsl) {
        return dsl.set(id).equalToWhenPresent(record::getId)
                .set(datasource_name).equalToWhenPresent(record::getDatasource_name)
