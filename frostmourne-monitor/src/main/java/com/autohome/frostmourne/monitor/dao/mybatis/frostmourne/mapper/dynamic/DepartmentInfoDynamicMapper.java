...
public interface DepartmentInfoDynamicMapper {
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2020-07-11T14:44:51.814+08:00", comments="Source Table: department_info")
    ...
    int insertMultiple(MultiRowInsertStatementProvider<DepartmentInfo> multipleInsertStatement);
    ...
    default int insert(DepartmentInfo record) {
        return MyBatis3Utils.insert(this::insert, record, departmentInfo, c ->
            ...
            .map(department_name).toProperty("department_name")
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2020-07-11T14:44:51.814+08:00", comments="Source Table: department_info")
    default int insertMultiple(Collection<DepartmentInfo> records) {
        return MyBatis3Utils.insertMultiple(this::insertMultiple, records, departmentInfo, c ->
            c.map(id).toProperty("id")
            .map(department_name).toProperty("department_name")
            .map(full_name).toProperty("full_name")
            .map(creator).toProperty("creator")
    ...
    default int insertSelective(DepartmentInfo record) {
        return MyBatis3Utils.insert(this::insert, record, departmentInfo, c ->
            ...
            .map(department_name).toPropertyWhenPresent("department_name", record::getDepartment_name)
    ...
    static UpdateDSL<UpdateModel> updateAllColumns(DepartmentInfo record, UpdateDSL<UpdateModel> dsl) {
        return dsl.set(id).equalTo(record::getId)
                .set(department_name).equalTo(record::getDepartment_name)
    ...
    static UpdateDSL<UpdateModel> updateSelectiveColumns(DepartmentInfo record, UpdateDSL<UpdateModel> dsl) {
        return dsl.set(id).equalToWhenPresent(record::getId)
                .set(department_name).equalToWhenPresent(record::getDepartment_name)
