...
public interface TeamInfoDynamicMapper {
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2020-07-29T23:40:25.344+08:00", comments="Source Table: team_info")
    ...
    default int insert(TeamInfo record) {
        return MyBatis3Utils.insert(this::insert, record, teamInfo, c ->
            c.map(team_name).toProperty("team_name")
    ...
    default int insertSelective(TeamInfo record) {
        return MyBatis3Utils.insert(this::insert, record, teamInfo, c ->
            c.map(team_name).toPropertyWhenPresent("team_name", record::getTeam_name)
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2020-07-29T23:40:25.345+08:00", comments="Source Table: team_info")
    ...
    static UpdateDSL<UpdateModel> updateAllColumns(TeamInfo record, UpdateDSL<UpdateModel> dsl) {
        return dsl.set(team_name).equalTo(record::getTeam_name)
    ...
    static UpdateDSL<UpdateModel> updateSelectiveColumns(TeamInfo record, UpdateDSL<UpdateModel> dsl) {
        return dsl.set(team_name).equalToWhenPresent(record::getTeam_name)
