...
public class DataNameController {
    ...
    public Protocol<PagerContract<DataSource>> findDataSource(@RequestParam(value = "_appId", required = true) String _appId,
        ...
        PagerContract<DataSource> pagerContract = dataAdminService.findDatasource(pageIndex, pageSize, datasourceType);
