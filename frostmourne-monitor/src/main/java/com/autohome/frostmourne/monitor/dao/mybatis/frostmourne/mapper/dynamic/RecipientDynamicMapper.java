...
public interface RecipientDynamicMapper {
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2020-07-11T14:44:51.802+08:00", comments="Source Table: recipient")
    ...
    int insertMultiple(MultiRowInsertStatementProvider<Recipient> multipleInsertStatement);
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2020-07-11T14:44:51.802+08:00", comments="Source Table: recipient")
    default int insertMultiple(Collection<Recipient> records) {
        return MyBatis3Utils.insertMultiple(this::insertMultiple, records, recipient, c ->
            c.map(id).toProperty("id")
            .map(alarm_id).toProperty("alarm_id")
            .map(alert_id).toProperty("alert_id")
            .map(account).toProperty("account")
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2020-07-11T14:44:51.803+08:00", comments="Source Table: recipient")
