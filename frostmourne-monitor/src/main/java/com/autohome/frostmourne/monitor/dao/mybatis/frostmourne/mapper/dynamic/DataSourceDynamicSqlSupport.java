...
public final class DataSourceDynamicSqlSupport {
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2020-07-11T14:44:51.794+08:00", comments="Source Table: data_source")
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2020-07-11T14:44:51.795+08:00", comments="Source field: data_source.datasource_name")
    public static final SqlColumn<String> datasource_name = dataSource.datasource_name;

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2020-07-11T14:44:51.795+08:00", comments="Source field: data_source.datasource_type")
    public static final SqlColumn<String> datasource_type = dataSource.datasource_type;

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2020-07-11T14:44:51.795+08:00", comments="Source field: data_source.service_address")
    public static final SqlColumn<String> service_address = dataSource.service_address;

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2020-07-11T14:44:51.795+08:00", comments="Source field: data_source.creator")
    public static final SqlColumn<String> creator = dataSource.creator;

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2020-07-11T14:44:51.795+08:00", comments="Source field: data_source.create_at")
    public static final SqlColumn<Date> create_at = dataSource.create_at;

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2020-07-11T14:44:51.795+08:00", comments="Source field: data_source.modifier")
    public static final SqlColumn<String> modifier = dataSource.modifier;

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2020-07-11T14:44:51.795+08:00", comments="Source field: data_source.modify_at")
    public static final SqlColumn<Date> modify_at = dataSource.modify_at;

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2020-07-11T14:44:51.795+08:00", comments="Source field: data_source.properties")
