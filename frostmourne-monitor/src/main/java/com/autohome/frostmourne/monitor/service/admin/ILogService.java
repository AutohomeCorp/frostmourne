...
public interface ILogService {
    ...
    PagerContract<AlarmLog> findAlarmLog(int pageIndex, int pageSize, Date startTime,
                                         Date endTime, Long alarmId, String verifyResult, String executeResult);


    PagerContract<AlertLog> findAlertLog(int pageIndex, int pageSize, Date startTime, Date endTime,
