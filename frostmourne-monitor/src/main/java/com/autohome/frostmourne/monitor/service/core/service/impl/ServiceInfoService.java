...
public class ServiceInfoService implements IServiceInfoService {
    ...
    @Override
    public void save(ServiceInfoSaveForm form, String account) {
    ...
    public Optional<ServiceInfoContract> getContract(Long id) {
        return serviceInfoRepository.getById(id).map(ServiceInfoTransformer::model2Contract);
    }
    ...
    public Optional<ServiceInfoSimpleContract> getSimpleContract(Long id) {
        return serviceInfoRepository.getById(id).map(ServiceInfoTransformer::model2SimpleContract);
    }
