...
public interface RulePropertyDynamicMapper {
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2020-07-11T14:44:51.807+08:00", comments="Source Table: rule_property")
    ...
    int insertMultiple(MultiRowInsertStatementProvider<RuleProperty> multipleInsertStatement);
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2020-07-11T14:44:51.806+08:00", comments="Source Table: rule_property")
    default int insertMultiple(Collection<RuleProperty> records) {
        return MyBatis3Utils.insertMultiple(this::insertMultiple, records, ruleProperty, c ->
            c.map(id).toProperty("id")
            .map(alarm_id).toProperty("alarm_id")
            .map(rule_id).toProperty("rule_id")
            .map(prop_key).toProperty("prop_key")
